...
@inspections_router.get("/inspections/new_inspection_data/{vehicle_number}/", tags=["Inspections"])
async def get_new_inspection_data(vehicle_number: str):
    return await new_inspection_data(vehicle_number)